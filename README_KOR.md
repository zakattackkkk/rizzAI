...
-   동시 실행 지원: `pnpm start --characters="path/to/your/character.json"` - 이 명령어를 사용하면, 여러 캐릭터 파일을 한번에 불러와, 다양한 봇을 동시에 실행 시킬 수 있습니다.
